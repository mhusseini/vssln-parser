export const ProjectTypeMappings = {
    ...
    "{FAE04EC0-301F-11D3-BF4B-00C04F79EFBC}": "C# | Windows (C#)",
    ...
    "{F184B08F-C81C-45F6-A57F-5ABD9991F28F}": "VB.NET | Windows (VB.NET)",
    ...
    "{349C5851-65DF-11DA-9384-00065B846F21}": "Web Application | ASP.NET MVC 5",
